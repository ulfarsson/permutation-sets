...
def get_example(ex):
    ...
    if ex == 1:
        ...
        prop = lambda x : occurrence_graph2(x,p).is_tree()
        return prop, 0
        ...
        prop = lambda x : occurrence_graph2(x,p).is_forest()
        return prop, 0
        ...
        prop = lambda x : occurrence_graph2(x,p).is_bipartite()
        return prop, 0
        ...
        prop = lambda x : occurrence_graph2(x,p).is_clique()
        return prop, 0
        ...
        prop = lambda x : occurrence_graph2(x,p).is_connected()
        return prop, 0
